...
export class PromoSiftApp {
  ...
  private async action(element: HTMLElement): Promise<void> {
    ...
    else if (action === "move-up" && id) this.moveBy(id, -1);
    else if (action === "move-down" && id) this.moveBy(id, 1);
